...
# Time-stamp:              <2016-07-29 18:10:00 jfulton> 
# -------------------------------------------------------
...
echo "Adding yaml to set RabbitMQ file descriptor limit"
cp ~/templates-diff/rabbit-fd-limits.yaml ~/templates/rabbit-fd-limits.yaml
